          ...
          <div className="items-center flex-shrink-0 hidden lg:flex">
            {
              user ? <>
                ...
                <button onClick={() => logOut()} type="button" className="px-8 py-3 font-semibold border rounded dark:border-gray-800 dark:text-gray-800">Logout</button>
              </> : <>
                <li><NavLink to='/login'>
                  {/* <button className="btn btn-outline">Login</button> */}
                  <button type="button" className="px-8 py-3 font-semibold border rounded dark:border-gray-800 dark:text-gray-800">Login</button>
                </NavLink></li>
              </>
            }
          </div>
