    ...
    return (
        <div>
            <div className='flex justify-between flex-wrap gap-4'>
                <div className="stats shadow duration-200 hover:scale-110">
                    <div className="stat">
                ...
                <div className="stats shadow duration-200 hover:scale-110">
                    <div className="stat">
                        <div className="stat-title text-4xl">Total Male</div>
                ...
                <div className="stats shadow duration-200 hover:scale-110">
                    <div className="stat">
                        <div className="stat-title text-4xl">Total Female</div>
                ...
                <div className="stats shadow duration-200 hover:scale-110">
                    <div className="stat">
                        <div className="stat-title text-4xl">Total Premium</div>
                ...
                <div className="stats shadow duration-200 hover:scale-110">
                    <div className="stat">
                        <div className="stat-title text-4xl">Total Revenue</div>
